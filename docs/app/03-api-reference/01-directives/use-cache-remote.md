...
export default async function ProductsPage({ params, searchParams }: { params: Promise<{ category: string }>; searchParams: Promise<{ minPrice?: string }> }) {
	return (
...
async function ProductList({ params, searchParams }: { params: Promise<{ category: string }>; searchParams: Promise<{ minPrice?: string }> }) {
